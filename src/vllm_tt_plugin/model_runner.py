...
class TTModelRunner:
    ...
    def _state_slot_inputs(
        ...
        """
        if not self.requires_persistent_request_state_slots:
            return (list(range(len(row_req_ids))) if is_prompt else None), None
        if is_prompt:
            return TTModelRunner._alloc_prefill_state_slots(self, row_req_ids), None
        return None, TTModelRunner._decode_state_slot_remap(self, row_req_ids)
    ...
    def _prepare_model_inputs(
        ...
        prefill_empty_slots, slot_remap = self._state_slot_inputs(
            row_req_ids, is_prompt=is_prompt
        )
