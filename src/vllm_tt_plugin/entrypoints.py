...
def register() -> None:
    ...
    Reasoning and tool parsing for TT-served models uses the parsers that
    ship with vLLM (``--reasoning-parser gemma4`` / ``--tool-call-parser
    gemma4`` for Gemma 4 and DiffusionGemma); the plugin registers nothing
    there.
    """
